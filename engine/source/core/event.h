...
bs__api__ b8 event_register(u16 code, VOID_PTR listener, PFN_on_event on_event);
bs__api__ b8 event_unregister(u16 code, VOID_PTR listener, PFN_on_event on_event);
bs__api__ b8 event_fire(u16 code, VOID_PTR listener, event_context context);
