...
struct Ship {
    ...
    bs_math::Vec2 origin;       // world offset of the ship
...
// Debug/introspection: writes the collider vertices transformed to WORLD-space in winding
// order. Returns FALSE if the ship has no collider (count == 0).
