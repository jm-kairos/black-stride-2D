...
- **Design docs:** `docs\` holds the authoritative design notes (galaxy generation architecture, trade economy, per-system ship AI, map generation). Check there before reworking those systems.
